...
import { p as defineHandlerCallback, a as rootRouteId, q as parseRedirect, u as mergeHeaders, b as isRedirect, v as getNormalizedURL, w as getOrigin, x as attachRouterServerSsrUtils, y as createSerializationAdapter, z as createRawStreamRPCPlugin, i as isNotFound, A as isResolvedRedirect, C as executeRewriteInput, D as defaultSerovalPlugins, E as makeSerovalPlugin, c as transformPipeableStreamWithRouter, t as transformReadableStreamWithRouter } from "../_libs/tanstack__router-core.mjs";
import { AsyncLocalStorage } from "node:async_hooks";
import { p as parseCookies, H as H3Event, t as toResponse, s as setCookie$1 } from "../_libs/h3-v2.mjs";
...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-no7JOTLA.mjs");
...
const manifest = { "aa82ee41b9c577cb7924a94c9cd5c0273e9904c43159409010260cd404205f5d": {
  functionName: "getAdminSession_createServerFn_handler",
  importer: () => import("./server-fns-DE9zvpJf.mjs")
}, "b996d118d38dc4d3c736274621e9f49906551aed916d514d8216c1b0d3e48e09": {
  functionName: "ensureAdminSession_createServerFn_handler",
  importer: () => import("./server-fns-DE9zvpJf.mjs")
}, "fb2be1589c3b2c4fc092baa27fec7a2ff9fbc85f97d12c57120f5591247a67e0": {
  functionName: "loginFn_createServerFn_handler",
  importer: () => import("./server-fns-DE9zvpJf.mjs")
}, "9d911051c9212e7701136163c415fa9167a5d2cb506c3710db12948386f0eda2": {
  functionName: "getAdminData_createServerFn_handler",
  importer: () => import("./server-fns-DE9zvpJf.mjs")
}, "47e16675823efac3d977d25b4b32e5d6076c2493a7059a5d1caacea5f6377319": {
  functionName: "saveLandingFn_createServerFn_handler",
  importer: () => import("./server-fns-DE9zvpJf.mjs")
}, "11e63ba0caa00fa22f17cbe8c28b61ca8b37fc1662dd6882c0123466680fef19": {
  functionName: "uploadMediaFn_createServerFn_handler",
  importer: () => import("./server-fns-DE9zvpJf.mjs")
}, "1d8567c8de012a589f79170be365d726725640eb0c932811be95ab21c63edbcc": {
  functionName: "deleteMediaFn_createServerFn_handler",
  importer: () => import("./server-fns-DE9zvpJf.mjs")
}, "9fd83906fd7674a25bd3f1145c9a49c7dcfad65a9a6db4b71546f2626434f715": {
  functionName: "getLandingContentFn_createServerFn_handler",
  importer: () => import("./server-fns-DE9zvpJf.mjs")
} };
...
async function loadEntries() {
  const routerEntry = await import("./router-Z7fNdJsU.mjs").then((n) => n.r);
...
const serverCMzxgZBk = /* @__PURE__ */ Object.freeze({
  __proto__: null,
  HEADERS,
  StartServer,
  attachRouterServerSsrUtils,
