...
function requireHelper() {
  ...
  hasRequiredHelper = 1;
  (function(module) {
    var path = require$$0, Stream = require$$5.Stream, split = /* @__PURE__ */ requireSplit2(), util = require$$1, defaultPort = 5432, isWin = process.platform === "win32", warnStream = process.stderr;
