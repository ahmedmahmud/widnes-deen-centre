...
import { g as getLocationConstraintPlugin } from "./@aws-sdk/middleware-location-constraint+[...].mjs";
...
export {
  CreateBucketCommand as C,
  DeleteObjectCommand as D,
  HeadBucketCommand as H,
  PutObjectCommand as P,
  S3Client as S,
  PutBucketPolicyCommand as a
};
